...
from model.utils.anchor_box import AnchorBox
from model.utils.utils import compute_iou
...
class LabelEncoder:
    ...
    def _encode_sample(self, image_shape, gt_boxes, cls_ids):
        ...
        cls_target = tf.where(tf.not_equal(positive_mask, 1.0), -1.0,
                              matched_gt_cls_ids)
    ...
    def encode_batch(self, batch_images, gt_boxes, cls_ids):
        ...
        labels = tf.TensorArray(dtype=tf.float32,
                                size=batch_size,
                                dynamic_size=True)
